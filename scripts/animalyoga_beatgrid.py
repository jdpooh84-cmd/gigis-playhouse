#!/usr/bin/env python3
"""Beat grid + structure analysis for Animal Yoga (calm mindful-movement song).
...
read and pinned to real bars. Output -> _staging/animalyoga/beatgrid.json
"""
import json, os, subprocess, sys
import numpy as np

AUDIO = "_staging/audio/animal-yoga.mp3"
SR = 22050
...
json.dump({"bpm":bpm,"bar_len":4*period/fps,"beat_period":period/fps,
          ...
          open("_staging/animalyoga/beatgrid.json","w"))
print("OK -> _staging/animalyoga/beatgrid.json")
