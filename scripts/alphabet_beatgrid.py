#!/usr/bin/env python3
"""Beat grid + structure analysis for Alphabet Adventure Train.
...
RMS-energy curve so section boundaries (intro / verse / chorus) can be read and the
lyric lines mapped onto real bars. Output -> _staging/alphabet/beatgrid.json
"""
import json, os, subprocess, sys
import numpy as np

AUDIO = "_staging/audio/alphabet-adventure-train.mp3"
SR = 22050
...
# print a compact energy sparkline every 4s so structure is visible
...
json.dump({"bpm":bpm,"bar_len":4*period/fps,"beat_period":period/fps,
          ...
          open("_staging/alphabet/beatgrid.json","w"))
print("OK -> _staging/alphabet/beatgrid.json")
