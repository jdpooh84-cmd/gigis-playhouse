#!/usr/bin/env python3
"""Beat grid + structure analysis for Jump With Me (calm mindful-movement song).
...
read and pinned to real bars. Output -> _staging/jump/beatgrid.json
"""
import json, os, subprocess, sys
import numpy as np

AUDIO = "_staging/audio/jump-with-me.mp3"
SR = 22050
...
json.dump({"bpm":bpm,"bar_len":4*period/fps,"beat_period":period/fps,
          ...
          open("_staging/jump/beatgrid.json","w"))
print("OK -> _staging/jump/beatgrid.json")
