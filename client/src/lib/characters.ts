...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    color: "#EC4899",
    bgClass: "bg-pink-100",
    description: "Creative bunny with paintbrushes who loves art and music",
    voice: { pitch: 1.4, rate: 0.95, webSpeechName: "Samantha" },
    greetings: ["Let's create something beautiful!", "Art is how we show our feelings!"],
    encouragements: ["There are no mistakes in art — only happy accidents!", "Express yourself!"],
    celebrations: ["What a masterpiece! I love it!", "You're so creative!"],
  },
  {
    id: "atlas",
    name: "Atlas",
